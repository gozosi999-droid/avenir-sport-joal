...
db = [
   ...
   Product("NK-003", "ADIDAS", "lIGHT", "ULTRABOOST", "Unisex", ["M", "L", "XL", "XXL"], 25000, "https://i.ibb.co/Tqh9ZW1j/image.jpg"),
    ...
    Product("AD-004", "ADIDAS", "CRAMPONS", "Predator 20+ FG/AG Inflight", "Unisex", ["40", "41", "42", "43", "44", "45"], 35000, "https://i.ibb.co/vv65nHhM/image.jpg", "ELITE"),
    Product("AD-005", "ADIDAS", "CRAMPONS", "X Speedportal+ FG Orange", "Unisex", ["40", "41", "42", "43", "44"], 40000, "https://i.ibb.co/KpMF9nPF/image.jpg", "ELITE"),
    # --- PUMA & NEW BALANCE ---
  ...
  Product("NB-001", "NEW BALANCE", "CRAMPONS", "New Balance Furon V7+", "Unisex", ["40", "41", "42", "43", "44"], 30000, "https://i.ibb.co/KzDvBsqd/image.jpg", "ELITE"),
    ...
    Product("ACC-01", "NIKE", "ACCESSOIRES", "Protège-Tibias Carbon", "Unisex", ["S", "M", "L"], 1500, "https://i.ibb.co/nsjnLfxv/image.jpg"),
